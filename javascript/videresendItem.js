...
var UKMVideresendItem = function($, type, innslag, id) {
    ...
    var self = {
        ...
        videresend: function() {
            ...
            self.ajax('videresend', { 'til': self.getTilArrangement() });
        ...
        avmeld: function() {
            ...
            self.ajax('avmeld', { 'til': self.getTilArrangement() });
        ...
        loadKontroll: function() {
            self.ajax('kontroll', { 'til': self.getTilArrangement() });
        },
        /**
